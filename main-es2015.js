...
let NewsboxLoginComponent = class NewsboxLoginComponent {
    constructor(fb) {
        this.fb = fb;
...
NewsboxLoginComponent.ctorParameters = () => [
...
let NewsboxRegister1Component = class NewsboxRegister1Component {
    constructor(fb) {
        this.fb = fb;
        this.nextScreen = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
...
NewsboxRegister1Component.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
...
let NewsboxRegister2Component = class NewsboxRegister2Component {
    constructor(fb) {
        this.fb = fb;
        this.nextScreen = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
...
NewsboxRegister2Component.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
...
let NewsboxRegister3Component = class NewsboxRegister3Component {
    constructor() {
        this.nextScreen = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    onSubmit() {
...
let PasswordLoginComponent = class PasswordLoginComponent {
    constructor(fb) {
        this.fb = fb;
        this.onFormGroupChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.nextScreen = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
...
PasswordLoginComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
let PhoneNumberComponent = class PhoneNumberComponent {
    constructor(fb) {
        this.fb = fb;
        this.onFormGroupChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.nextScreen = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
...
PhoneNumberComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
...
let RegisterFormComponent = class RegisterFormComponent {
    ...
    get phone() { return this.phoneNumber.controls; }
    get passwordC() { return this.password.controls; }
    get otpC() { return this.otp.controls; }
...
let TroubleLoginComponent = class TroubleLoginComponent {
    constructor(fb) {
        this.fb = fb;
        this.nextScreen = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
...
TroubleLoginComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
...
let UserRegister1Component = class UserRegister1Component {
    constructor(fb) {
        this.fb = fb;
        this.onFormGroupChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.nextScreen = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
...
UserRegister1Component.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
...
let UserRegister2Component = class UserRegister2Component {
    constructor() { }
    ngOnInit() {
    }
};
...
let UserRegister3Component = class UserRegister3Component {
    constructor() { }
    ngOnInit() {
    }
};
